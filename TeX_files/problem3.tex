...
\begin{figure}[H]
	\centering
	\includegraphics[scale=0.35]{patch.png}
	\caption{patch resonant at $2.45GHz$}
	\label{patch}
\end{figure}
\begin{figure}[H]
	\centering
	\includegraphics[scale=0.35]{patch_mesh.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[scale=0.35]{array.png}
	\caption{patch resonant at $2.45GHz$}
	\label{array}
\end{figure}
...
\begin{figure}[H]
	\centering
	\includegraphics[scale=0.35]{array_real.png}
	\caption{real part of Z11 of the array}
	\label{array_imm}
\end{figure}
\begin{figure}[H]
	\centering
	\includegraphics[scale=0.35]{array_imm.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[scale=0.35]{array_scat.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[scale=0.35]{rad_pattern_array.png}
	\caption{radiation of the array}
\end{figure}
\begin{figure}[H]
	\centering
	\includegraphics[scale=0.35]{rad_pattern_patch.png}
	\caption{radiation of the single patch}
\end{figure}
\begin{figure}[H]
	\centering
	\includegraphics[scale=0.35]{rad_pattern_AF.png}
